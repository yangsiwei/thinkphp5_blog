<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\phpStudy\WWW\blog\public/../application/admin\view\link\store.html";i:1498700633;s:63:"D:\phpStudy\WWW\blog\public/../application/admin\view\base.html";i:1503538731;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo url('admin/entry/layout'); ?>">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="">添加编辑</a></li>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="link_name"  class="form-control" value="<?php echo $oldData['link_name']; ?>" placeholder="请填写友链名称">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="url" name="link_url"  class="form-control" placeholder="" value="<?php echo $oldData['link_url']; ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">排序</label>
                <div class="col-sm-9">
                    <input type="number" name="link_sort"  class="form-control" placeholder="" value="<?php echo $oldData['link_sort']; ?>">
                </div>
            </div>
        </div>
    </div>
